        ...
        <div
            ...
            <div class="max-h-[400px] overflow-y-auto">
                @forelse ($notifications as $notification)
                    <div  
                        wire:click="markAsRead('{{ $notification['id'] }}', '{{ $notification['link'] }}')"
                        class="flex items-start gap-4 px-6 py-5 hover:bg-bkkNeutral-50 transition border-b border-bkkNeutral-50 last:border-none group cursor-pointer">
                        ...
                        <div class="flex flex-col gap-0.5 overflow-hidden">
                            ...
                            <h4 class="paragraph-14s text-bkkNeutral-900 font-bold truncate">
                                {{ $notification['title'] }}
                            </h4>
