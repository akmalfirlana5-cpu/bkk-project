...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Ambil data primary color dari db --}}
        @php
            $primaryColor = $Global_settings['theme']['primary_color'] ?? '#073AE4';
        @endphp
        ...
        <style>
            ...
            :root {
                ...
                --color-primary-ultra-light: color-mix(in srgb, var(--color-primary), white 92%);
            }
        </style>
    </head>
    <body>
                ...
                <div 
                    ...
                    <div 
                        ...
                        <a 
                            ...
                            href="{{ route('beranda') }}" 
                            class="paragraph-16s {{ request()->routeIs('beranda') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                            Beranda
                        </a>
                        <div class="relative">
                            <a 
                                ...
                                :class="openDropdown === 'profilBkk' ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary'"
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-4">
                                    <a href="{{ route('visi-misi') }}" 
                                        class="paragraph-16r {{ request()->routeIs('visi-misi') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Visi & Misi
                                    </a>
                                    <a href="{{ route('struktur-organisasi') }}" 
                                        class="paragraph-16r {{ request()->routeIs('struktur-organisasi') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Struktur Organisasi
                                    </a>
                                    <a href="{{ route('program-kerja') }}" 
                                        class="paragraph-16r {{ request()->routeIs('program-kerja') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Program Kerja
                                    </a>
                                    <a href="{{ route('alur-kegiatan') }}" 
                                        class="paragraph-16r {{ request()->routeIs('alur-kegiatan') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Alur Kegiatan
                                    </a>
                                    <a href="{{ route('dokumen-pendukung') }}" 
                                        class="paragraph-16r {{ request()->routeIs('dokumen-pendukung') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Dokumen Pendukung
                                    </a>
                                </div>
                            </div>
                        ...
                        <a 
                            ...
                            class="paragraph-16s {{ request()->routeIs('perusahaan') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-2">
                            Perusahaan
                        </a>
                        <a 
                            href="{{ route('lowongan') }}" 
                            class="paragraph-16s {{ request()->routeIs('lowongan') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300"
                            @mouseenter="openDropdown = null">
                            Lowongan
                        </a>
                        <div class="relative">
                            <a 
                                href="#" 
                                class="flex items-center gap-3 paragraph-16s transition duration-300"
                                :class="openDropdown === 'informasiPengumuman' ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary'"
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-4">
                                    <a href="{{ route('pengumuman') }}"
                                        class="paragraph-16r {{ request()->routeIs('pengumuman') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">
                                        Pengumuman
                                    </a>
                                    <a href="{{ route('tracer-study') }}"
                                        class="paragraph-16r {{ request()->routeIs('tracer-study') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300">Tracer Study
                                    </a>
                                    <a href="{{ route('survey') }}"
                        ...
                        <a 
                            href="{{ route('faq') }}" 
                            class="paragraph-16s {{ request()->routeIs('faq') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300"
                            @mouseenter="openDropdown = null">
                            FAQ
                        </a>
                        <a 
                    ...
                    @else
                        <div class="flex items-center gap-3">
                            <a 
                                ...
                                class="bg-primary hover:bg-primary-hover px-4 py-2 paragraph-16s text-bkkNeutral-50 transition duration-300 rounded-[8px] border-[1px] border-primary cursor-pointer">Masuk sebagai Alumni</a>
                        </div>
                    @endauth
                </div>
            </nav>
            ...
            <nav x-data="{open: false}" class="lg:hidden bg-bkkNeutral-50 fixed top-0 z-[99] w-full">
                ...
                <div 
                    ...
                    @auth
                        ...
                        :class="openMobile && openDropdownMobile === 'userPage' ? 'text-primary' : 'text-bkkNeutral-900'"
                        class="py-2">
                    ...
                    <a 
                        href="{{ route('beranda') }}" 
                        class="paragraph-16s {{ request()->routeIs('beranda') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-2">
                        Beranda
                    </a>
                    {{-- Profil Menu Mobile --}}
                    <div 
                        @click="openMobile = !openMobile; openDropdownMobile = 'profilBkk'"
                        :class="openMobile && openDropdownMobile === 'profilBkk' ? 'text-primary' : 'text-bkkNeutral-900'"
                        class="py-2">
                        <div class="flex items-center justify-between">
                            <div 
                                class="paragraph-16s transition duration-300">
                        ...
                        <div 
                            ...
                            class="pt-4 flex flex-col gap-2">
                            <a href="{{ route('visi-misi') }}" 
                                class="paragraph-16r {{ request()->routeIs('visi-misi') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-1">
                                Visi & Misi
                            </a>
                            <a href="{{ route('struktur-organisasi') }}" 
                                class="paragraph-16r {{ request()->routeIs('struktur-organisasi') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-1">
                                Struktur Organisasi
                            </a>
                            <a href="{{ route('program-kerja') }}" 
                                class="paragraph-16r {{ request()->routeIs('program-kerja') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-1">
                                Program Kerja
                            </a>
                            <a href="{{ route('alur-kegiatan') }}" 
                                class="paragraph-16r {{ request()->routeIs('alur-kegiatan') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-1">
                                Alur Kegiatan
                            </a>
                            <a href="{{ route('dokumen-pendukung') }}" 
                                class="paragraph-16r {{ request()->routeIs('dokumen-pendukung') ? 'text-primary' : 'text-bkkNeutral-900 hover:text-primary' }} transition duration-300 py-1">
                                Dokumen Pendukung
                            </a>
                        </div>
                    </div>
                    ...
                    <div 
                        ...
                        :class="openMobile && openDropdownMobile === 'informasi' ? 'text-primary' : 'text-bkkNeutral-900'"
                        class="py-2">
                        <div class="flex items-center justify-between">
                            <div 
                                class="paragraph-16s transition duration-300">
                ...
                <div class="container mx-auto lg:px-0 px-5 pt-20 ">
                    <div class="flex flex-col lg:flex-row lg:justify-between items-start border-b-[1px] border-bkkNeutral-500 pb-10 lg:pb-20">
                        <div class="w-full md:w-[60%] lg:w-[35%] text-bkkNeutral-50 mb-12 lg:mb-0">
                            <a href="{{ route('beranda') }}" class="block w-max mb-7">
                                <img 
                                    class="w-[170px] h-full object-contain" 
                                    src="{{ $Global_settings['footer']['logo'] 
                                        ? asset('storage/' . $Global_settings['footer']['logo'])
                                        : asset('/assets/static/partial/image-fallback.webp') }}"/>
                            </a>
                            <div class="paragraph-14r mb-4 w-full lg:w-[75%]">
                                {{ $Global_settings['footer']['description'] }}
                            </div>
                            <div class="flex items-center gap-3">
                                {{-- Telegram --}}
                                <a 
                                    target="_blank"
                                    href="{{ $Global_settings['footer']['social_telegram'] }}">
                                ...
                                <a 
                                    target="_blank"
                                    href="{{ $Global_settings['footer']['social_facebook'] }}">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a 
                                    target="_blank"
                                    href="{{ $Global_settings['footer']['social_instagram'] }}">
                        ...
                        <div class="w-1/2 lg:w-1/3">
                                <div class="space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        @foreach ($Global_settings['footer']['related_links'] as $links)
                                            <a 
                                                target="_blank"
                                                href="{{ $links['url'] }}" 
                                                class="paragraph-14r text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300 block">{{ $links['label'] }}</a>
                                        @endforeach
                                    </div>
                                </div>
                        </div>
                        <div class="w-1/2 lg:w-1/3">
                            <div class="space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        @foreach ($Global_settings['footer']['service_links'] as $links)
                                            <a href="{{ $links['url'] }}" class="paragraph-14r text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300 block">{{ $links['label'] }}</a>
                                        @endforeach
                                    </div>
                                </div>
                        </div>
                        <div class="w-full lg:w-1/3 mt-10 lg:mt-0">
                            <div class="space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        <a 
                                            target="_blank"
                                            href="{{ $Global_settings['footer']['contact_address_url'] }}" 
                                            class="flex  gap-3 paragraph-14r text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300 ">
                                            ...
                                            <span>{{ $Global_settings['footer']['contact_address'] }}</span>
                                        </a>
                                        <a 
                                            target="_blank" href="mailto:{{ $Global_settings['footer']['contact_email'] }}" 
                                            class="flex items-center gap-3 paragraph-14r text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300 ">
                                            ...
                                            <span>{{ $Global_settings['footer']['contact_email'] }}</span>
                                        </a>
                                        <a 
                                            target="_blank"
                                            href="tel:{{ $Global_settings['footer']['contact_phone'] }}" 
                                            class="flex items-center gap-3 paragraph-14r text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300 ">
                                            ...
                                            <span>{{ $Global_settings['footer']['contact_phone'] }}</span>
                                        </a>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="flex flex-col-reverse md:flex-row items-center justify-between py-8 paragraph-14r text-bkkNeutral-50 gap-6 md:gap-0">
                        <div>{{ $Global_settings['footer']['copyright'] }}</div>
                        <div class="flex items-center gap-5 md:gap-10">
                            <a 
                            href="{{ $Global_settings['footer']['privacy_policy_url'] }}"
                            class="text-bkkNeutral-50 hover:text-bkkNeutral-200 transition duration-300">Kebijakan Privasi</a>
                            <a 
                            href="{{ $Global_settings['footer']['terms_url'] }}"
